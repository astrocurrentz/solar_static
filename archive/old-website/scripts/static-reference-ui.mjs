...
const generatedJsMarker = '/* GENERATED FILE: edit shared/copy/site-copy.mjs instead. */';

export const buildReferenceUi = () => `${generatedJsMarker}
const STORAGE_KEYS = {
  script: 'solarstatic.bazi.reference.script.v1',
};

const DEFAULT_SCRIPT = 'hans';
const EXTERNAL_COPY = ${JSON.stringify({
  loadingHans: SITE_COPY.external.loadingHans,
  loadingHant: SITE_COPY.external.loadingHant,
  loadFailedHans: SITE_COPY.external.loadFailedHans,
  loadFailedHant: SITE_COPY.external.loadFailedHant,
  switchToHans: SITE_COPY.external.switchToHans,
  switchToHant: SITE_COPY.external.switchToHant,
  scriptHansButton: SITE_COPY.external.scriptHansButton,
  scriptHantButton: SITE_COPY.external.scriptHantButton,
})};
